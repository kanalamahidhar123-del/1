...
const RULES: Rule[] = [
  ...
  {
    keywords: ['offer', 'discount', 'deal', 'save', 'instagram offer', '50%', 'second attempt', 'promo', 'coupon'],
    answer: `Follow our Instagram @unlimited_fun_is_here and get 50% off your second attempt! Offer subject to applicable park terms and verification.`,
  },
  {
  ...
  {
    keywords: ['child', 'children', 'kid', 'kids', 'bidda', 'pilla', 'age', 'can kids', 'children can'],
    answer: `Yes, children can enjoy Unlimited Fun! We have dedicated children's pricing: 1 Hour — ₹350, 2 Hours — ₹600. Participants must be below ${SITE.weightLimit}.`,
  },
  {
    keywords: ['adult', 'adults', 'mature', 'can adults', 'age limit', 'too old', 'elder'],
    answer: `Yes, adults can enjoy all activities at Unlimited Fun! Adult pricing: 1 Hour — ₹500, 2 Hours — ₹850. Participants must be below ${SITE.weightLimit}.`,
  },
  {
