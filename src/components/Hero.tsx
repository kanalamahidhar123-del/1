  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src="https://images.pexels.com/photos/6571947/pexels-photo-6571947.jpeg?auto=compress&cs=tinysrgb&w=1920"
          alt="Athlete jumping on trampoline indoors at Unlimited Fun Bhimavaram"
